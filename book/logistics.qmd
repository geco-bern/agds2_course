...
- The two evaluated Report Exercises can be chosen among the four possible Report Exercises – one for each Block ([Phenology Modelling](https://geco-bern.github.io/handfull_of_pixels/exercises.html#phenology-modelling), [Digital Soil Mapping](https://geco-bern.github.io/tutorial_digital_soil_mapping/99-exercise.html), [Land cover classification](https://geco-bern.github.io/handfull_of_pixels/exercises.html#land-use-and-land-cover-modelling), or [Spatial upscaling](https://geco-bern.github.io/spatial_upscaling/exercise.html)).
